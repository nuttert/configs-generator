 ...
 * </pre>
 */
public class JoinWithCamelCase implements Mustache.Lambda {
    private CodegenConfig generator = null;

    public JoinWithCamelCase() {

    }

    public JoinWithCamelCase generator(final CodegenConfig generator) {
    ...
    public void execute(Template.Fragment fragment, Writer writer) throws IOException {
        ...
        for(String str:substr) str = camelize(str,false);
