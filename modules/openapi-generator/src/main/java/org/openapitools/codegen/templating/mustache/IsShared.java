 ...
 * </pre>
 */
public class IsShared implements Mustache.Lambda {
    private CodegenConfig generator = null;
    private Boolean escapeParam = false;
    private Boolean lowercaseFirstLetter = true;

    public IsShared(boolean lowercaseFirstLetter) {
      this.lowercaseFirstLetter = lowercaseFirstLetter;
    }

    public IsShared() {}

    public IsShared generator(final CodegenConfig generator) {
        this.generator = generator;
        return this;
    }

    public IsShared escapeAsParamName(final Boolean escape) {
    ...
    public void execute(Template.Fragment fragment, Writer writer) throws IOException {
        String text = fragment.execute().indexOf("shared_ptr") == -1 ?  "" : "*";
