...
public class DefaultGenerator implements Generator {
    ...
    private Map<String, Object> processOperations(CodegenConfig config, String tag, List<CodegenOperation> ops, List<Object> allModels) {
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_api_names__.txt", true))
        {
           for (CodegenOperation op : ops) {
                  String text = op.operationIdCamelCase + ":";
                  writer.write(text);
                  writer.flush();
           }
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_api_paths__.txt", true))
        {
           for (CodegenOperation op : ops) {
                  String text = op.path + ":";;
                  writer.write(text);
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_api_methods__.txt", true))
        {
           for (CodegenOperation op : ops) {
                  String text = op.httpMethod + ":";;
                  writer.write(text);
                  writer.flush();
           }
        }catch(IOException ex){
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_api_tags__.txt", true))
        {
            for (CodegenOperation op : ops) {
                  String text = tag + ":";;
                  writer.write(text);
    ...
    private Map<String, Object> processModels(CodegenConfig config, Map<String, Schema> definitions) {
        ...
        List<CodegenModel> codgen_models = new ArrayList<>();
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_models_names__.txt", true))
        {
           for (CodegenModel mo : codgen_models) {
                  String text = mo.classname + ":";
                  writer.write(text);
                  writer.flush();
           }
        }catch(IOException ex){
        ...
        try(FileWriter writer = new FileWriter(".temp/__env_models_filenames__.txt", true))
        {
           for (CodegenModel mo : codgen_models) {
                  String text = mo.classFilename + ":";
                  writer.write(text);
                  writer.flush();
           }
        }catch(IOException ex){
