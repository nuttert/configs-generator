 ...
 * </pre>
 */
public class SnakeCase implements Mustache.Lambda {
    private CodegenConfig generator = null;
    private Boolean escapeParam = false;
    private Boolean lowercaseFirstLetter = true;

    public SnakeCase(boolean lowercaseFirstLetter) {
      this.lowercaseFirstLetter = lowercaseFirstLetter;
    }

    public SnakeCase() {}

    public SnakeCase generator(final CodegenConfig generator) {
        this.generator = generator;
        return this;
    }

    public SnakeCase escapeAsParamName(final Boolean escape) {
    ...
    public void execute(Template.Fragment fragment, Writer writer) throws IOException {
        ...
        String text = CaseFormat.UPPER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, fragment.execute()).toLowerCase().replaceAll("-", "_");
        if (generator != null) {
