...
public class CodegenOperation {
    ...
    public String path, fullPath, operationId, returnType, returnFormat, httpMethod, returnBaseType,
    ...
    public int hashCode() {
        ...
        return Objects.hash(responseHeaders, hasAuthMethods, hasConsumes, hasProduces, hasParams, hasOptionalParams,
                ...
                isCallbackRequest, uniqueItems, path,fullPath, operationId, returnType, httpMethod, returnBaseType,
